...
export default function FlipCardPage() {
  ...
  const cards = [
    { id: 1, front: 'گزینه اول', back: 'رستوران', description: 'رستوران ایتالیایی خفن توی شهران' },
    { id: 2, front: 'گزینه دوم', back: 'وی آر', description: 'کلی بازی های خفن دوتایی' },
    { id: 3, front: 'گزینه سوم', back: 'دوچرخه سواری', description: 'دوچرخه سواری توی ساحل دریاچه چیتگر' }
  ];
